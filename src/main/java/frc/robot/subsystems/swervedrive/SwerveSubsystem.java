...
public SwerveSubsystem(File directory) {
	...
	/*
	 * Configure telemetry before creating the drivetrain.
	 */
	...
	try {
		...
		throw new RuntimeException(
			"Failed to create the swerve drivetrain",
			exception);
	}
...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  public BooleanSupplier isOnLeft() {
    BooleanSupplier leftSideSupplier;
    if (swerveDrive.getPose().getY() >= 4) {
      leftSideSupplier = () -> false;
      return leftSideSupplier;
    } else {
      leftSideSupplier = () -> true;
      return leftSideSupplier;
    }
  }
  ...
  public BooleanSupplier getIsRedAlliance()
  {
    var alliance = DriverStation.getAlliance();
    return () -> alliance.isPresent() ? alliance.get() == DriverStation.Alliance.Red : false;
  }

    public Boolean nonS_getIsRedAlliance()
  {
    var alliance = DriverStation.getAlliance();
    return alliance.isPresent() ? alliance.get() == DriverStation.Alliance.Red : false;
  }
